defmodule TasktrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{completed: true, description: "some description", time_spent: 42}
  @update_attrs %{completed: false, description: "some updated description", time_spent: 43}
  @invalid_attrs %{completed: nil, description: nil, time_spent: nil}
