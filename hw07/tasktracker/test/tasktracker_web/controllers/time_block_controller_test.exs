defmodule TasktrackerWeb.TimeBlockControllerTest do
  ...
  @create_attrs %{time_beg: ~N[2010-04-17 14:00:00.000000], time_end: ~N[2010-04-17 14:00:00.000000]}
  ...
  def fixture(:time_block) do
    {:ok, time_block} = Activity.create_time_block(@create_attrs)
    time_block
  end
  ...
  describe "create time_block" do
    test "renders time_block when data is valid", %{conn: conn} do
      ...
      assert json_response(conn, 200)["data"] == %{
        "id" => id,
        "time_beg" => ~N[2010-04-17 14:00:00.000000],
        "time_end" => ~N[2010-04-17 14:00:00.000000]}
    end
  ...
  describe "update time_block" do
    ...
    test "renders time_block when data is valid", %{conn: conn, time_block: %TimeBlock{id: id} = time_block} do
      ...
      assert json_response(conn, 200)["data"] == %{
        "id" => id,
        "time_beg" => ~N[2011-05-18 15:01:01.000000],
        "time_end" => ~N[2011-05-18 15:01:01.000000]}
    end
