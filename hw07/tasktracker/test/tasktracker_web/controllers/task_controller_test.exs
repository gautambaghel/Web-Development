defmodule TasktrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{completed: true, description: "some description", name: "some name", time_beg: ~N[2010-04-17 14:00:00.000000], time_end: ~N[2010-04-17 14:00:00.000000]}
  ...
  def fixture(:task) do
    {:ok, task} = Activity.create_task(@create_attrs)
    task
  end
